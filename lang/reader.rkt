(module reader syntax/module-reader
  ...
  super/main
  ;   The module path `super/main` is used in the language position
  ;   of read modules. That is, reading `#lang super` will produce a
  ;   module with `super/main` as language.
